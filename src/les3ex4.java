...
public class les3ex4 {
    ...
    public void findSearchResult() {
        ...
        waitForWordInElement(
                By.id("org.wikipedia:id/search_results_list"),
                By.id("org.wikipedia:id/page_list_item_title"),
                "Cannot find Java in each search result",
                "Java"
        );
    }
    ...
    private void waitForWordInElement(By externalBy, By internalBy, String error_message, String value) {
        driver.hideKeyboard();
